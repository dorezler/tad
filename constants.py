...
VISUALIZATIONS_GRID_COLS = 2
VISUALIZATIONS_GRID_ROWS = 2
...
NETWORK_REQUEST_TIMEOUT = 10

# 1.7. Status bar
STATUS_FILE_LOAD_FAILED_TEMPLATE = "Failed to load data: {error}"
...
# 4.1. Styles
PDF_CHART_ASPECT_RATIO = 0.5
PDF_CHART_SIZE = (8, 4)
PDF_PAGE_MARGIN_MM = 15
PDF_SPACER_LARGE = 10
PDF_SPACER_MEDIUM = 8
PDF_SPACER_SMALL = 6
PDF_SPACER_XLARGE = 12
PDF_SPACER_XSMALL = 4
PDF_SPACER_XXSMALL = 2
PDF_STYLE_CODE = "Code"
